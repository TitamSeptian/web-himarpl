...
<head>
    ...
    <title>Situs Resmi HIMARPL</title>
</head>
...
<body>
    ...
    <header class="header sticky-top blog">
        <nav class="navbar navbar-expand-lg py-3">
            <div class="container">
                ...
                <button type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
                    ...
                    class="navbar-toggler navbar-toggler-right text-color-2"><i class="fa fa-bars"></i></button>

                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        {{-- <li class="nav-item">
                            <a href="./index.html" class="nav-link text-uppercase font-weight-bold text-dark">Menu 1</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link text-uppercase font-weight-bold text-dark">Menu 2</a>
                        </li> --}}
                        <li class="nav-item active2">
                            <a href="{{ route('home') }}"
                                class="nav-link text-uppercase font-weight-bold text-dark">Beranda</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <main class="blog-main px-4 pb-5">
        <section class="blog-title text-center p-4 pb-5">
            <div>
                <a href="#" class="text-muted">Announcement</a>
                <span class="text-muted"> | </span>
                <a href="#" class="text-muted">Patreon HQ</a>
            </div>
            ...
            <div>
                April 7, 2021
                <span class="text-muted"> | </span>
                <a href="#" class="text-danger font-weight-bold">Patreon</a>
            </div>
        </section>

        <div class="hero d-flex justify-content-center">
            <img src="./assets/img/sample-blog-image.png" alt="Sample Image" class="mw-100">
        </div>

        <section class="blog-content mt-5 d-flex flex-column flex-sm-row">
            <aside class="media-social h-100 d-flex d-sm-block justify-content-center">
                <div class="media-social-container d-flex flex-sm-column flex-row">
                    <a href="https://www.instagram.com/himarpl/" data-aos="flip-left" target="_blank"
                        class="mx-2 mx-sm-0 mb-2 mb-sm-0">
                    ...
                    <a href="https://www.instagram.com/himarpl/" data-aos="flip-left" target="_blank"
                        class="mx-2 mx-sm-0 mb-2 mb-sm-0">
                        <svg class="social-footer mt-sm-2" width="35" height="35" viewBox="0 0 56 56" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div class="blog-article">
                <p>
                    Professional creativity has finally gone mainstream. And <strong>we knew this day would
                        come</strong>. Never before in human history have people been so connected, and the barriers to
                    making amazing content so low. There are over four billion people online, and more than a billion of
                    them have phones that can produce movie studio quality content right in their pocket. That
                    combination of connectivity and creation tools has fueled a creative rebirth the world hasn’t seen
                    since da Vinci and Michelangelo picked up their paintbrushes and blew everyone’s minds right out of
                    the 16th century.
                </p>

                <p>
                    The creative economy is booming. It seems like every week, a new platform emerges to get creators
                    paid, between the NFTs, Super Follows, virtual chats, tipping, livestreams, and more. Creators are
                    experiencing more success than ever before, and becoming household names. It’s no wonder that 75% of
                    children 6 to 17 chose video creator as their most desired career\*. Now it’s just as normal to say
                    you want to be a creator when you grow up as a lawyer or a doctor.
                </p>

                <p>
                    Our mission has always been to enable creators to do what they love and get paid by the people who
                    love them. Today, there are over 200,000 creators sharing their work on Patreon, earning over $100M
                    per month from more than 7 million patrons across the world. We’re incredibly humbled by the
                    opportunity to help so many creators pursue their dreams and build passionate communities around
                    them. And we’re just getting started.
                </p>

                <p>
                    To kick our mission into high gear, <strong>we’ve raised a Series F funding round of $155M at a $4B
                        valuation</strong>. That’s *over three times bigger* than where we were just six months ago.
                    This is proof of the incredible power and potential of creators, and of building this new economy.
                </p>

                <p>
                    What does this mean? In the simplest terms, it means that we now have the opportunity to expand our
                    ability to power a creator’s evolution and growth. With these additional resources, we’re going to
                    continue focusing on three key areas: <strong>enhancing the patron and creator experiences</strong>
                    on both mobile and desktop; adding <strong>new content consumption tools</strong>; and going global.
                    Patreon is – and will continue to be – a place where creators can build their own worlds, on their
                    own terms. And now, those worlds can be as big as a creator can dream.
                </p>

                <p>
                    Patreon is doing more than getting creators paid; the work we’re doing is driving the <a
                        href="#">Second Renaissance</a> that we’ll be experiencing for decades to come, enabling more
                    creators to build businesses doing what they love. As creators ourselves, we understand what these
                    creators need to truly thrive.
                </p>

                <p>
                    A new era of creativity is here, one that we’ve championed for years, and we can’t wait to build
                    more of what the future holds for all of us.
                </p>
